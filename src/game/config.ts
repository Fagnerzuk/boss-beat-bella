...
export const BOSSES: BossConfig[] = [
  {
    ...
    desc: "Vilão aéreo que ataca do planador — voa em rasantes rápidos e mergulha para soltar bombas.",
  ...
  },
  {
    ...
    desc: "Cientista com quatro tentáculos mecânicos — anda devagar no chão e chicoteia em médio alcance.",
    musicUrl: "",
  ...
  },
  {
    ...
    desc: "Simbionte brutal e resistente — se desloca em saltos pesados que causam impacto ao aterrissar.",
    musicUrl: "",
  ...
  },
  {
    ...
    desc: "Chefe do crime enorme e blindado — avança em passos lentos e constantes, sem recuar nunca.",
    musicUrl: "",
  ...
  },
  {
    ...
    desc: "Inimigo instável cheio de portais — some e reaparece por teleporte em pontos aleatórios da arena.",
    musicUrl: "",
